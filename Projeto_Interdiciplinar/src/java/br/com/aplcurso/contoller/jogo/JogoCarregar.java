...
@WebServlet(name = "JogoCarregar", urlPatterns = {"/JogoCarregar"})
public class JogoCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("jogo", dao.carregar(idJogo));
            request.getRequestDispatcher("cadastros/jogo/cadastrarJogos.jsp").forward(request, response);
        } catch (Exception e) {
            System.out.println("Problemas na servlet carregar Jogo! Erro: " + e.getMessage());
            e.printStackTrace();
        }
    }
