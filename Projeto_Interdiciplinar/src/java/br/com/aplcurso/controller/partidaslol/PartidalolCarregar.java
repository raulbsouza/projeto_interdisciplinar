 ...
 * @author Aluno
 */
@WebServlet(name = "PartidalolCarregar", urlPatterns = {"/PartidalolCarregar"})
public class PartidalolCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("partidas", dao.carregar(idPartida));
            request.getRequestDispatcher("/cadastros/lol/partidas/cadastrarPartida.jsp").forward(request, response);
        } catch (Exception e) {
